    ...
    def post(self, request):
        ...
        try:
            completion = client.chat.completions.create(
                model="sonar",
                messages=[
                    {"role": "system", "content": "With this document slide generate a detailed document for study , highlight the important topic and give real world examples if applicable, also recommend the topic related to it including the links , generate the response in html format."},
